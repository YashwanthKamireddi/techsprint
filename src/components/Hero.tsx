        ...
        <section className="relative min-h-[calc(100vh-80px)] pb-[36px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
                <div className="mb-8 inline-block">
                    <span className="px-4 py-1.5 rounded-full border border-(--io-border) bg-white/50 dark:bg-[#121212]/50 backdrop-blur-sm text-sm font-medium text-gray-600 dark:text-white/50">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <button onClick={handleRegister} className="px-8 py-4 bg-[#2563eb] text-white rounded-full text-lg font-medium hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
                        Register Now
                    </button>
