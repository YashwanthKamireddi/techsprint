  ...
  return (
    <div className="social_footer">
      <div className="social_body">
        ...
        <div>
          <a
            href="https://www.instagram.com/gdgoc/"
            target="_blank"
          ...
          >
            ...
            >
              <title>GDG on Campus GITAM Instagram Page</title>
              <g fill="none" fill-rule="evenodd" transform="translate(-52)">
                <g transform="translate(52)" fill="#00B698">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <title>GDG on Campus GITAM</title>
              <circle fill="#00B698" cx="12" cy="12" r="12"></circle>
              <path
                fill="#fff"
              ...
              <path
                fill="#00B698"
                d="M9.88,11l1,3.08L14.12,13l-1-3.07L9.88,11Z"
              ></path>
            </svg>
          </a>
        </div>
      ...
      <div className="social_gif">
        <img
          ...
          // data-src="https://res.cloudinary.com/limhenry/image/upload/v1555595550/ioxkl19_pwa/io19_hashtag.gif"
          src="/assets/images/iwd.svg"
        />
      </div>
    </div>
  );
